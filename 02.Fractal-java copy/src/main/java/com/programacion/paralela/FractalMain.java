...
public class FractalMain {
    ...
    private void init() {
        ...
        glfwSetKeyCallback(window, (window, key, scancode, action, mods) -> {
            ...
            if (key == GLFW_KEY_3 && action == GLFW_RELEASE) {
                System.out.println("Modo Java Threads");
                modo = 3;
                title = "Java Hilos";
            }
        });
    ...
    private void loop() {
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            String threadInfo = modo == 3 ? " | Hilos: " + fractalHilos.getThreadCount() : "";
            glfwSetWindowTitle(window, "Fractal " + title + threadInfo + " | FPS: " + fps + " | Iteraciones: " + FractalParams.maxIteraciones);
    ...
    public void paint() {
        ...
        if (modo == 1) {
            ...
            fractalHilos.juliaThreads(FractalParams.xMin, FractalParams.yMin, FractalParams.xMax,
                    FractalParams.yMax, FractalParams.WIDTH, FractalParams.HEIGHT);
